    ...
    >
      <div className="flex items-center gap-2 p-2 bg-background-tertiary rounded-t-lg">
        ...
        <button
          ...
          title={effect.enabled ? "Desactivar efecto" : "Activar efecto"}
        >
          {effect.enabled ? (
...
const EFFECT_TYPES: {
  ...
  { type: "brightness", label: "Brillo", category: "Básicos" },
  { type: "contrast", label: "Contraste", category: "Básicos" },
  { type: "saturation", label: "Saturación", category: "Básicos" },
  { type: "temperature", label: "Temperatura", category: "Color" },
  { type: "tint", label: "Matiz", category: "Color" },
  { type: "blur", label: "Desenfoque", category: "Desenfoque" },
  { type: "motion-blur", label: "Desenfoque de movimiento", category: "Desenfoque" },
  { type: "radial-blur", label: "Desenfoque radial", category: "Desenfoque" },
  { type: "sharpen", label: "Nitidez", category: "Creativos" },
  { type: "vignette", label: "Viñeta", category: "Creativos" },
  { type: "grain", label: "Grano de película", category: "Creativos" },
  { type: "shadow", label: "Sombra paralela", category: "Estilizar" },
  { type: "glow", label: "Resplandor", category: "Estilizar" },
  { type: "chromatic-aberration", label: "Aberración cromática", category: "Estilizar" },
];
